...
if (!requests.every((request) => request.headers.authorization === "Bearer fake-token" && request.headers.cookie === undefined)) throw new Error("OAuth auth header missing or web session leaked");
